export const company = {
  name: 'Eserveconn Ltd',
  shortName: 'Eserveconn',
  location: 'Gisenyi, Rubavu District, Rwanda',
  industry: 'Software Development',
  tagline: 'Empowering Rwanda Through Smart Digital Solutions',
  email: 'eserveconne@gmail.com',
  phone: '0788836180',
  mission:
    'Deliver innovative, reliable, and scalable digital solutions that solve real-world challenges for businesses, schools, organizations, and communities.',
  vision:
