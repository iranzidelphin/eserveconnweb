export const reasons = [
  { title: 'Professional Team', description: 'Focused engineers and leaders with a practical, client-first mindset.' },
  { title: 'Modern Technologies', description: 'React, cloud platforms, APIs, and scalable architecture patterns.' },
